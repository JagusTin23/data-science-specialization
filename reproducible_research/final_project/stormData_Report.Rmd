...
#setwd("/Users/Tin/Desktop/rcoursera/ReproRes/PA2/")
storm.data.small <- readRDS("storm_small.Rds")
p1 <- ggplot(storm.data.small, aes(x = YEAR)) + xlab("Year") + ylab("Frequency") + geom_histogram(bins = 30, binwidth = 1,  color = "black", fill = "cornflowerblue", show.legend = FALSE) + ggtitle("Cases Recorded by Year") 
p1
```
